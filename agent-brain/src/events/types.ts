...
export interface StreamEvent {
  ...
  /** Event type */
  type: 'chat_message' | 'viewer_count' | 'donation' | 'milestone' | 'engagement_spike' | 'stream_status';

  /** Platform-agnostic event data */
  data: ChatMessageData | ViewerCountData | DonationData | MilestoneData | EngagementData | StreamStatusData;
}
