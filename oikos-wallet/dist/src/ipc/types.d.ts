...
export type IPCRequestType = 'propose_payment' | 'propose_rgb_issue' | 'propose_rgb_transfer' | 'query_balance' | 'query_balance_all' | 'query_address' | 'query_policy' | 'query_audit' | 'query_rgb_assets' | 'query_policy_check' | 'spark_create_invoice' | 'spark_pay_invoice' | 'spark_deposit_address';
export interface IPCRequest {
    id: string;
    type: IPCRequestType;
    source?: ProposalSource;
    payload: PaymentProposal | RGBIssueProposal | RGBTransferProposal | BalanceQuery | AddressQuery | Record<string, unknown> | AuditQuery;
}
...
export interface IPCResponse {
    ...
    payload: ExecutionResult | BalanceResponse | BalanceResponse[] | AddressResponse | {
